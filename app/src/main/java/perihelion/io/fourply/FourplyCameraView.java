 ...
 */
public class FourplyCameraView extends CameraBridgeViewBase implements Camera.PreviewCallback {

    private static final int MAGIC_TEXTURE_ID = 10;
    private static final String TAG = "FourplyCameraView";
    ...
    public FourplyCameraView(Context context, int cameraId) {
        super(context, cameraId);
    }

    public FourplyCameraView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
...
//        Log.d(TAG, "Preview Frame received. Frame size: " + frame.length);
    ...
    private class CameraWorker implements Runnable {
        ...
        public void run() {
            do {
                synchronized (FourplyCameraView.this) {
                    try {
                        FourplyCameraView.this.wait();
                    } catch (InterruptedException e) {
